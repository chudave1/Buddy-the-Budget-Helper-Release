...
<img src="{{ '/screenshots/Main Window.jpg' | relative_url }}" alt="Main Window">
...
<img src="{{ '/screenshots/Page Layout.jpg' | relative_url }}" alt="Page Layout">
...
<img src="{{ '/screenshots/Account List.jpg' | relative_url }}" alt="Account List">
...
<img src="{{ '/screenshots/Category Hierarchy.jpg' | relative_url }}" alt="Category Hierarchy">
...
<img src="{{ '/screenshots/Reconcile window.jpg' | relative_url }}" alt="Reconcile window">
...
<img src="{{ '/screenshots/Assign Category.jpg' | relative_url }}" alt="Assign Category">
...
<img src="{{ '/screenshots/Assign Category (split).jpg' | relative_url }}" alt="Assign Category (split)">
...
<img src="{{ '/screenshots/Split Category Amounts.jpg' | relative_url }}" alt="Split Category Amounts">
...
<img src="{{ '/screenshots/Actual versus Budget Dashboard.jpg' | relative_url }}" alt="Actual versus Budget Dashboard">
...
<img src="{{ '/screenshots/Year versus Year Dasboard.jpg' | relative_url }}" alt="Year versus Year Dashboard">
...
<img src="{{ '/screenshots/Breakdown Dashboard.jpg' | relative_url }}" alt="Breakdown Dashboard">
...
<img src="{{ '/screenshots/Uses SQLite.jpg' | relative_url }}" alt="Uses SQLite">
