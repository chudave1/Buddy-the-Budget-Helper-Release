...
- [SimpleFIN Integration](simplefin-integration.md)
- [Working with the Main Window](main-window.md)
- [Performing Analysis](performing-analysis.md)
- [Starting a New Year](starting-new-year.md)
